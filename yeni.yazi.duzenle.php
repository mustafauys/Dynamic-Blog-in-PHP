    ...
    $SQL = sprintf("UPDATE yazilar
          ...
          if( $EksikVeriVar == 0) { // Eksik veri bulunmuyor.
           ...
           // Yeni eklenen makale sayfasına geçiş yap
            header("location: index.php?yaziid={$_GET["edityaziid"]}");
            die();
          }
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-xl-8 offset-xl-2 py-5">
      ...
      <h1 class="text-center">Blog Yazısı Güncelleme</h1>
          ...
          <div class="row">
              ...
              <div class="col-md-10 offset-md-1">
                  <div class="form-group">
                      Yazı Başlığı
                      <input type="text" name="baslik" value="<?php echo $row["baslik"];?>" class="form-control" >
                  </div>
              </div>
              ...
              <div class="col-md-10 offset-md-1">
                  <div class="form-group">
                      Yazı Spotu (Özet)
                      <input type="text" name="yazi_spotu" value="<?php echo $row["yazi_spotu"];?>" class="form-control" >
                  </div>
              </div>
              ...
              <div class="col-md-10 offset-md-1">
                  <div class="form-group">
                      Yazıldığı Tarih
                      <input type="text" name="yazildigi_tarih" value="<?php echo $row["yazildigi_tarih"];?>" class="form-control" value="<?php echo date("Y-m-d"); ?>" >
                  </div>
              </div>
              ...
              <div class="col-md-10 offset-md-1">
                  <div class="form-group">
                      Yayınlanacağı Tarih
                      <input type="text" name="yayinlanacagi_tarih" value="<?php echo $row["yayinlanacagi_tarih"];?>" class="form-control" value="<?php echo date("Y-m-d"); ?>" >
                  </div>
              </div>
              ...
              <div class="col-md-12">
                  <div class="form-group">
                      ...
                      <textarea name="yazi" class="form-control" rows="10" ><?php echo $row["yazi"];?></textarea>
                  </div>
              </div>
              <div class="col-md-12">
